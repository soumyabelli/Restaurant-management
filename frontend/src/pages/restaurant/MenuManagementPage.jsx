          ...
          <div className="card" style={{ width: "100%", maxWidth: "500px", background: "white", padding: "24px", borderRadius: "12px", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <input type="text" placeholder="e.g. 🍕 or https://..." value={formData.emoji} onChange={e => setFormData({...formData, emoji: e.target.value})} style={{ width: "100%", padding: "10px", borderRadius: "8px", border: "1px solid #cbd5e1" }} />
              </div>
